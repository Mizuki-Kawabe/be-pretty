  ...
  <Container max-width="7xl">
      <div className="text-center mt-8 grid gap-10 md:grid-cols-2 md:items-center md:text-left">
          ...
          <div className="grid md:gap-10 sm:gap-5">
            ...
            <Button variant="outlined" className="text-orange border-orange focus:border-orange max-w-md">browse products</Button>
            <Button variant="outlined" className="text-orange border-orange focus:border-orange max-w-md">book appointment</Button>
            </div>
          </div>
      <div className="">
      </div>
